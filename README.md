...
The current setup does not include configuration management for the Tazama platform i.e., db configuration, rules configuration, env variables, etc. It covers only the initial deployment of the core Tazama platform services onto Kubernetes.