...
-- Core typology for public rules 901 and 902.
-- Adapted from tazama-stack core/postgres/migration/config/00-public-base.sql
-- and the Dom tazama-notes network map.
...
values (
 '{
   ...
   "config": {
     ...
     "bands": [
       { "subRuleRef": ".01", "upperLimit": 2, "reason": "The debtor has performed one transaction in the last day" },
       { "subRuleRef": ".02", "lowerLimit": 2, "upperLimit": 3, "reason": "The debtor has performed two transactions in the last day" },
       { "subRuleRef": ".03", "lowerLimit": 3, "reason": "The debtor has performed three or more transactions in the last day" }
     ]
   }
 }'
), (
 '{
   ...
   "config": {
     ...
     "exitConditions": [{ "subRuleRef": ".x00", "reason": "Incoming transaction is unsuccessful" }],
     "bands": [
       { "subRuleRef": ".01", "upperLimit": 2, "reason": "The creditor has received one transaction in the last day" },
       { "subRuleRef": ".02", "lowerLimit": 2, "upperLimit": 3, "reason": "The creditor has received two transactions in the last day" },
       { "subRuleRef": ".03", "lowerLimit": 3, "reason": "The creditor has received three or more transactions in the last day" }
     ]
   }
 }'
), (
       ...
       "typologies": [
         {
           ...
           "tenantId": "DEFAULT",
           "rules": [
             { "id": "EFRuP@4.0.0", "cfg": "none" },
             { "id": "901@4.0.0", "cfg": "4.0.0" },
             { "id": "902@4.0.0", "cfg": "4.0.0" }
           ]
         }
       ]
     }
